		...
		<form class="form" id="form" method="post" enctype="multipart/form-data" action="">
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
							<input name="sdt" id="param_name" _autocheck="true" type="number" value="<?= set_value('sdt') ?>">
						</span>
						<span name="name_autocheck" class="autocheck"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
							<input name="fax" id="param_name" _autocheck="true" type="number" value="<?= set_value('fax') ?>">
						</span>
						<span name="name_autocheck" class="autocheck"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
							<input name="email" id="param_name" _autocheck="true" type="email" value="<?= set_value('email') ?>">
						</span>
						<span name="name_autocheck" class="autocheck"></span>
						<div name="name_error" class="clear error"></div>
					</div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
							<textarea name="diachi" id="param_name" _autocheck="true" type="text" value="<?= set_value('diachi') ?>"> </textarea>
						</span>
						<span name="name_autocheck" class="autocheck"></span>
